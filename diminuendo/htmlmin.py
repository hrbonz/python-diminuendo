...
EXCLUDE_TAGS = ("pre", "script", "style", "textarea",)
...
def minify(code, ignore_comments=True, fold_doctype=True,
           parser="html5lib"):
    """The minification heart, gets some HTML code and returns a
    minified version.

    :param code: an HTML string
    :type code: str
    :param ignore_comments: if True, comments will be removed from the
                            minified code
    :type ignore_comments: bool
    :param fold_doctype: if True, no newline after the doctype element
    :type fold_doctype: bool
    :param parser: a valid beautifulsoup parser name
    :type parser: str
    """
    soup = bs4.BeautifulSoup(code, parser)
